...
void Engine::Initialize() {
    ...
    std::__fs::filesystem::path lighting_vs_path = shader_dir / "lighting.vs";
    std::__fs::filesystem::path lighting_fs_path = shader_dir / "lighting.fs";
    ...
    m_lightShader = new Shader(lighting_vs_path.c_str(), lighting_fs_path.c_str());
    ...
    m_ecsHandler->RegisterComponent<Transform>();
}
